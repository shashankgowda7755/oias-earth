...
export const config = {
  ...
  // admin session (POST /auth/demo-login). PUBLIC BACKDOOR — kept OFF by default
  // per product owner; explicitly opt in with ALLOW_DEMO_LOGIN=true for a demo,
  // and REMOVE this route before real launch.
