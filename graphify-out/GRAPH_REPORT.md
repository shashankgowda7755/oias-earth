...
4. `notFound()` - 41 edges
5. `useToast()` - 33 edges
6. `badRequest()` - 31 edges
7. `assertForestAccess()` - 30 edges
8. `sample` - 29 edges
...
Cohesion: 0.04
Nodes (46): additional_sponsor_logo, boundary_gap, box_columns, box_data, box_rows, box_to_box_distance, climate, climate_other (+38 more)
...
Cohesion: 0.06
Nodes (30): ADDED Requirements, Requirement: Absent data renders blank, never fabricated, Requirement: Carbon and oxygen are presented as estimates, never credits, Requirement: Editing report data never mutates the tree record, Requirement: Preview renders from a bundled fixture without a server, Requirement: Quarterly forest report renders 22 navigable slides, Requirement: Report can be downloaded as a client-rendered PDF, Requirement: Report figures use fiscal quarters (+22 more)
...
Cohesion: 0.09
Nodes (23): code:bash (mkdir -p graphify-out), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash (graphify export wiki), code:bash (graphify export svg), code:bash (graphify export graphml), code:bash (graphify benchmark), code:bash ($(cat graphify-out/.graphify_python) -c "), code:block31 (Graph complete. Outputs in PATH_TO_DIR/graphify-out/) (+15 more)

### Community 27 - "Community 27"
Cohesion: 0.10
Nodes (26): allCorners, bCentre, bearing(), blkTrees, BLOCKS, box, brg, buildGrid() (+18 more)
...
Cohesion: 0.10
Nodes (24): bearing(), BL, bot, BR, BR0(), brg, c, cam (+16 more)
...
Cohesion: 0.08
Nodes (24): compilerOptions, allowImportingTsExtensions, baseUrl, exactOptionalPropertyTypes, forceConsistentCasingInFileNames, isolatedModules, jsx, lib (+16 more)
...
Cohesion: 0.09
Nodes (23): first_name, id, forest_name, forest_unique_id, id, sample, CreatedBy, end_date (+15 more)
...
Cohesion: 0.11
Nodes (21): bearing(), box, c, cam, { Client }, d2r(), dest(), dist (+13 more)
...
Cohesion: 0.13
Nodes (20): code:block1 (/quarterly-session <forest_internal_id> <year> <Q1|Q2|Q3|Q4>), code:block10 (data: Q{n} {year} report for {forest_id}), code:block2 (/quarterly-session CGICGI57 2026 Q3), code:block3 (Starting Q{n} {year} session for {forest_id}.), code:block4 (https://communitree-rebuild.vercel.app), code:block5 (Forest {forest_id} not found. Check the ID and try again.), code:block6 (Auto-fill complete. Filled: [list fields].), code:block7 (I need values for Q{n} {year} — please provide all of these:) (+12 more)
...
Cohesion: 0.10
Nodes (19): ADDED Requirements, Requirement: Every login attempt and data mutation is recorded, Requirement: Login successes and failures are captured, Requirement: Public report downloads are logged, Requirement: The activity log is queryable and segregated by category, Requirement: The Logs view surfaces the trail read-only, Scenario: A data mutation is logged on response finish, Scenario: A logging failure never breaks the request (+11 more)
...
Cohesion: 0.12
Nodes (18): fields, list, sample, carbonOffsetPerDay, commonName, id, isActive, isFloweringPlant (+10 more)
...
Cohesion: 0.13
Nodes (17): dependencies, bcryptjs, cors, dotenv, @electric-sql/pglite, express, jsonwebtoken, multer (+9 more)
...
Cohesion: 0.12
Nodes (15): 0. The reframes that matter, 1. Capture kit (one-time, trivial vs labour), 2. Edit → stitch → pointer → render, 3. Operating model — LOCAL CREWS, never a travelling crew, 4. Unit economics — cost/tree/cycle (full deliverable), 5. The wedge + pricing, 6. Validate before bidding (one number rules everything), 7. Platform build actions (small, high-leverage) (+7 more)
...
Cohesion: 0.06
Nodes (29): Requirement: CC resolution on report sends, Requirement: Report PDF attachment, Requirement: Sent inbox (send log), Requirement: Single-provider outbound email, Requirement: Tracked editable templates, Scenario: Admin views the inbox, Scenario: DB override wins over code default, Scenario: Every attempt is logged (+21 more)
...
Cohesion: 0.10
Nodes (19): Forest Geo-tagging Specification, Purpose, Requirement: Per-tree geo-tagging, Requirement: Public forest map, Requirements, Scenario: Capture by device GPS, Scenario: Forest markers cluster at scale, Scenario: Read-only for non-capture roles (+11 more)

### Community 75 - "Community 75"
Cohesion: 0.12
Nodes (14): Architecture consensus (Eng lens), /autoplan REVIEW REPORT (2026-06-18), CEO verdict: reframe + resequence, CONSENSUS TABLE, CRITICAL — discovered live bug (independent of 360), Dependencies / risks, Design consensus (4/10 as written), DX consensus (biggest risk = silent-success lie) (+6 more)

### Community 76 - "Community 76"
Cohesion: 0.13
Nodes (15): appBg, border, danger, darkInk, navBarBg, navBarText, navBarTextInactive, primary (+7 more)

### Community 77 - "Community 77"
Cohesion: 0.13
Nodes (15): failed, failure_count, processed, success_count, total_count, boxes, message, success (+7 more)
...
Cohesion: 0.17
Nodes (7): fetchForestPanoramas(), ForestPanorama, PublicTree, isPanoImage(), SponsorPortal(), STATUS_COLOR, STATUS_LABEL
...
Cohesion: 0.09
Nodes (21): dom-crash-resilience Specification, Purpose, Requirements, Requirement: Admin always loads the latest deployed build, Requirement: Client survives third-party DOM mutation without crashing, Scenario: Admin route loads after a new deploy, Scenario: Field route remains offline-capable, Scenario: Guard installs exactly once (+13 more)

### Community 87 - "Community 87"
Cohesion: 0.21
Nodes (10): box, c0, d2r(), dest(), haversine(), layoutBox(), q, quad (+2 more)
...
Cohesion: 0.17
Nodes (10): Capture Integrity Specification, Purpose, Requirement: Demonstration data disclosure, Requirement: GPS plausibility, Requirement: Photo de-duplication, Requirements, Scenario: Demo banner on proof page, Scenario: Imported legacy data labelled (+2 more)
...
Cohesion: 0.10
Nodes (19): ADDED Requirements, Requirement: Admin always loads the latest deployed build, Requirement: Client survives third-party DOM mutation without crashing, Scenario: Admin route loads after a new deploy, Scenario: Field route remains offline-capable, Scenario: Guard installs exactly once, Scenario: insertBefore reference node is no longer a child, Scenario: New service worker activates promptly (+11 more)
...
Cohesion: 0.22
Nodes (4): STATUS_LABEL, fetchForestScenes(), ForestScene, SceneHotspot

### Community 112 - "Community 112"
Cohesion: 0.28
Nodes (7): fetchSponsors(), Sponsor, GAPS, Landing(), PROOF_STEPS, useCountUp(), useReveal()

### Community 113 - "Community 113"
Cohesion: 0.18
Nodes (9): Auth & Roles Specification, Purpose, Requirement: Offline field capture, Requirement: Raw-token authentication, Requirement: Role-scoped forest access, Requirements, Scenario: Bearer prefix rejected, Scenario: Capture offline then sync (+1 more)

### Community 114 - "Community 114"
Cohesion: 0.21
Nodes (10): ADDED Requirements, Requirement: Images upload natively throughout the editor, Requirement: List items are edited atomically, Requirement: Report list returns report_data for edit prefill, Requirement: The report-data editor autosaves per field, Scenario: Add a quarter photo from the editor, Scenario: Concurrent adds to the same list, Scenario: Edit an existing report (+2 more)

### Community 115 - "Community 115"
Cohesion: 0.18
Nodes (9): ADDED Requirements, code:block1 (/quarterly-session <forest_internal_id> <year> <Q1|Q2|Q3|Q4>), code:block2 (/quarterly-session CGICGI57 2026 Q3), Requirement: Operator can complete a quarterly report session in ~10 minutes via Claude skill, Requirement: Skill is discoverable and self-documented, Scenario: Auto-fills report back to operator, Scenario: Full automated session for Q2-Q4, Scenario: Missing lat/long — weather skipped (+1 more)

### Community 116 - "Community 116"
Cohesion: 0.18
Nodes (9): ADDED Requirements, Requirement: Calendar-derivable maintenance counts are not typed, Requirement: Festival holidays from an operator-supplied calendar, Requirement: Growth targets from per-species curves, Requirement: Species health and mortality are derived from tree status, Scenario: Festival count pre-filled for a known state, Scenario: Mortality derived from status counts, Scenario: Sundays auto-counted (+1 more)
...
Cohesion: 0.36
Nodes (8): 1. Storage, 2. Recorder + IP helper, 3. Mutation middleware, 4. Login events, 5. List endpoint, 6. Public download logger, 7. Client Logs view, 8. Build, deploy, verify

### Community 124 - "Community 124"
Cohesion: 0.36
Nodes (8): 1. Climate auto-fill (Open-Meteo), 2. One-person quarterly form, 3. PFA photo app + storage, 4. Multi-sponsor logos, 5. Per-quarter photo gallery, 6. Rendering integrity, 7. Recipient data, 8. Verification (done)
...
Cohesion: 0.20
Nodes (8): code:bash (# Install dependencies), Conventions, graphify, Key Commands, Notes, Overview, Project, Tech Stack

### Community 128 - "Community 128"
Cohesion: 0.29
Nodes (8): includeFiles, maxDuration, buildCommand, functions, api/index.js, outputDirectory, rewrites, version

### Community 129 - "Community 129"
Cohesion: 0.20
Nodes (8): ADDED Requirements, Requirement: Missing photos render a default image, not an empty box, Requirement: The cover leads with the forest name and description, Requirement: The quarterly report surfaces every entered forest field, Scenario: Empty photo slot, Scenario: Long description does not overflow, Scenario: Per-box planting layout appears, Scenario: Supervisor and sponsor render from the data

### Community 130 - "Community 130"
Cohesion: 0.36
Nodes (8): 1. Renderer shell + navigation, 2. Slides + primitives, 3. Client compute (`reportCompute.ts`), 4. Server builder + endpoint, 5. Report-data entry forms, 6. Client-side PDF download, 7. Preview fixture, 8. Build, deploy, verify

### Community 131 - "Community 131"
Cohesion: 0.20
Nodes (8): 1. Forest create/upsert — FULL payload (`forest_create_payload.jsonc`), 2. Bulk tree / gift allocation sheet (`bulk_tree_gift_sheet.csv`, Google Sheet gid 1834015868), 3. Other Sheet (gid 2082403732) — INACCESSIBLE, Build implications, Enums (exact values), Forest Create + Bulk Tree/Gift Contracts (from user-provided artifacts), Rich/reporting JSON columns (each maps to a `forests.<col>` jsonb), Top-level groups

### Community 132 - "Community 132"
Cohesion: 0.25
Nodes (8): area_population_statistics_details, environmental_need, google_earth_image, green_cover, population, population_density, region_name, total_jurisdiction_area

### Community 133 - "Community 133"
Cohesion: 0.25
Nodes (8): direct_and_indirect_beneficiaries, de_weeding_crew, people_living_near, people_visiting, plant_health_specialist, schools_colleges, site_supervisor, watering_team
...
Cohesion: 0.24
Nodes (8): Requirement: Editing a forest hydrates the full record, Requirement: Forest update is non-destructive, Requirement: Uploaded media is stored durably, Scenario: Edit basic info only, Scenario: Open an existing forest for edit, Scenario: Upload a sponsor logo in production, ADDED Requirements, ADDED Requirements
...
Cohesion: 0.22
Nodes (7): Cover + default image, Deploy reliability, Editor: autosave + atomic list edits + native uploads, Forest edit: hydration + non-destructive + durable uploads, Report shows every entered field, Tasks, Verify

### Community 140 - "Community 140"
Cohesion: 0.22
Nodes (7): ADDED Requirements, Requirement: The report includes a per-quarter photo gallery, Requirement: The report renders every sponsor with its own title, Scenario: Empty gallery, Scenario: Gallery shows one photo per quarter, Scenario: Manage logos from the PFA app, Scenario: Multiple sponsors with distinct titles

### Community 141 - "Community 141"
Cohesion: 0.22
Nodes (7): ADDED Requirements, Requirement: Field staff capture photos from a mobile app, Requirement: Report photos are uploaded to durable object storage, Scenario: Capture and attach a photo on a phone, Scenario: Existing photos are reflected, Scenario: Storage not configured, Scenario: Upload a photo to a slot

### Community 142 - "Community 142"
Cohesion: 0.22
Nodes (7): ADDED Requirements, Requirement: One guided entry point per quarter, Requirement: Q1 captures the full report; Q2–Q4 show only what changes, Scenario: Advanced fields are opt-in, Scenario: Generated Q2 report includes carried-forward setup, Scenario: Second-quarter delta entry, Scenario: Start a report from the Reports tab

### Community 143 - "Community 143"
Cohesion: 0.22
Nodes (8): ADDED Requirements, Requirement: Computed totals match actual data, Requirement: Report slides are empty-safe and never show misleading zeros, Scenario: Broken or missing image, Scenario: Growth range with a typo, Scenario: Site-Master-Plan total, Scenario: Unset soil/temperature readings, ADDED Requirements

### Community 144 - "Community 144"
Cohesion: 0.15
Nodes (11): ADDED Requirements, Requirement: Growth heights are shown as entered, not capped, Requirement: Site master plan tolerates the grid-name split, Scenario: Forest carries plural grid aliases, Scenario: Forest carries singular grid names, Scenario: Negative height floored, Scenario: Tree taller than the old 30 ft cap, ADDED Requirements (+3 more)
...
Cohesion: 0.22
Nodes (7): code:bash (# Install dependencies), Conventions, Key Commands, Notes, Overview, Project, Tech Stack
...
Cohesion: 0.22
Nodes (7): code:json ({ "data": {), Create / Update — UPSERT (multipart), Delete (HARD delete), Inference for other entities, List (read), Row actions, Write Contracts (confirmed by live test on staging, 2026-06-16)
...
Cohesion: 0.25
Nodes (6): Build / Integration Status, Integration changes applied, Known non-blocking items / TODOs (top), Section completion, Smoke test — LIVE on embedded PGlite (no external Postgres) ✅, Verification (whole monorepo, prior static pass)
...
Cohesion: 0.29
Nodes (6): Architecture (3 layers), Build status (on communitree-rebuild.vercel.app), Guardrails, OIAS Earth — Living Proof Venture (vision + build status), Revenue engines (one verified dataset), Thesis
...
Cohesion: 0.18
Nodes (9): forest-map-visibility Specification, Purpose, Requirements, Requirement: Every forest is an individually visible pin, Scenario: No active, located forest is dropped, Scenario: Overlapping forests fan out, Requirement: Every forest is an individually visible pin, Scenario: No active, located forest is dropped (+1 more)
...
Cohesion: 0.43
Nodes (6): 1. Diagnosis, 2. Create-time coordinate guard, 3. De-stack overlapping pins, 4. Data cleanup, 5. Build + ship, 6. Follow-up (open)

### Community 172 - "Community 172"
Cohesion: 0.43
Nodes (6): 1. Provider consolidation (Resend only), 2. Tracked templates, 3. CC resolution, 4. PDF attachment, 5. Sent inbox (email_log), 6. Build + ship
...
Cohesion: 0.29
Nodes (7): area_population_statistics_details, environmental_need, google_earth_image, green_cover, population, population_density, total_jurisdiction_area
...
Cohesion: 0.29
Nodes (6): DOMAIN_OF, DOMAINS, domainsJson, fs, json, S

### Community 184 - "Community 184"
Cohesion: 0.25
Nodes (6): ADDED Requirements, Requirement: Bulk seed import is idempotent and duplicate-safe, Requirement: Seed migrations never crash cold-start boot, Scenario: Import on a populated production DB, Scenario: Migration re-runs on every cold start, Scenario: Target DB already has duplicate sponsor names
...
Cohesion: 0.29
Nodes (7): designTokens, shadows, spacing, appBar, card, dialog, scale

### Community 189 - "Community 189"
Cohesion: 0.25
Nodes (6): Geo-tagging model, Geo-tagging & Species Data — live inspection (read-only), How the impact numbers are derived, Maps stack, Rebuild implications, Species data (`master_plantspecies` table)
...
Cohesion: 0.29
Nodes (5): Cleanup is reversible, Design notes, Guard placement, It was never a data bug, Why jitter instead of only clustering

### Community 193 - "Community 193"
Cohesion: 0.29
Nodes (5): Design notes, Logging contract, Template precedence, Where the PDF is generated, Why Resend over Composio

### Community 194 - "Community 194"
Cohesion: 0.29
Nodes (5): App error boundary, Dashboard bento home, Form focus fix, Honest job status, Tasks

### Community 195 - "Community 195"
Cohesion: 0.50
Nodes (4): forest_id, total_number_of_boxes, total_number_of_trees, job_description

### Community 196 - "Community 196"
Cohesion: 0.33
Nodes (6): authorization_details, authorized_by_designation, authorized_by_name, authorized_date, authorized_period, project_context
...
Cohesion: 0.29
Nodes (5): ADDED Requirements, Requirement: Numeric field measurements are validated at capture, Scenario: Non-numeric measurement blocked before save, Scenario: Queued offline measurement coerced on replay, Scenario: Valid measurement submitted as a number
...
Cohesion: 0.29
Nodes (5): ADDED Requirements, Requirement: Quarterly weather is derived, not typed, Scenario: Auto-fill outside readings for a started quarter, Scenario: Forest without coordinates, Scenario: On-site (inside) readings are never overwritten
...
Cohesion: 0.48
Nodes (5): 1. Matrix layout engine, 2. ForestPage (/forest/:id) matrix mini-map, 3. PublicMap (/map) per-forest drill-down, 4. Satellite basemap + forest pin, 5. Build, deploy, verify
...
Cohesion: 0.29
Nodes (5): ADDED Requirements, Requirement: A render crash never shows a blank screen, Requirement: Admin form dialogs keep input focus across keystrokes, Scenario: A component throws while rendering, Scenario: Typing in a create/edit dialog

### Community 208 - "Community 208"
Cohesion: 0.48
Nodes (5): 1. Geo-measurement helpers, 2. Restor.eco-style boundary editor, 3. Boundary import + persistence, 4. Location picker geocoding, 5. Build, deploy, verify
...
Cohesion: 0.29
Nodes (6): ADDED Requirements, Requirement: A report is openable and downloadable, Requirement: Admins can create, edit and delete forest reports, Scenario: Create a report from the UI, Scenario: Download the report as a file, ADDED Requirements
...
Cohesion: 0.29
Nodes (5): 1. Site Master Plan grid name tolerance, 2. Remove the 30 ft height ceiling, 3. Validate field height/diameter at capture, 4. Verify, Tasks — report-render-and-capture-fixes
...
Cohesion: 0.40
Nodes (5): { Client }, crypto, main(), OpenTimestamps, sha256()

### Community 218 - "Community 218"
Cohesion: 0.33
Nodes (6): radii, button, card, iconButton, input, pill

### Community 219 - "Community 219"
Cohesion: 0.33
Nodes (6): authorized_by_designation, authorized_by_name, authorized_date, authorized_period, project_context, authorization_details
...
Cohesion: 0.40
Nodes (3): CITIES, { Client }, SPONSORS
...
Cohesion: 0.33
Nodes (4): MODIFIED Requirements, Requirement: Quarterly weather can be persisted with estimated provenance, Scenario: Estimated values are labelled and overridable, Scenario: Persist outside readings for a started quarter

### Community 229 - "Community 229"
Cohesion: 0.29
Nodes (5): Requirement: The forest boundary is editable on an interactive satellite map, Scenario: Import a plot polygon, Scenario: Refine a traced boundary, ADDED Requirements, ADDED Requirements

### Community 230 - "Community 230"
Cohesion: 0.53
Nodes (4): 1. Global DOM guard, 2. Per-site defense-in-depth, 3. Service-worker scoping, 4. Build, deploy, verify
...
Cohesion: 0.22
Nodes (7): ADDED Requirements, Requirement: Every forest is an individually visible pin, Scenario: No active, located forest is dropped, Scenario: Overlapping forests fan out, Requirement: Every forest is an individually visible pin, Scenario: No active, located forest is dropped, Scenario: Overlapping forests fan out
...
Cohesion: 0.33
Nodes (4): ADDED Requirements, Requirement: Value-flow figures are computed from the operator's formula, Scenario: Missing inputs render blank, not zero, Scenario: Value-flow auto-populated
...
Cohesion: 0.40
Nodes (5): content-type, headers, method, url, payload

### Community 241 - "Community 241"
Cohesion: 0.33
Nodes (4): Requirement: The admin opens on a bento overview, Scenario: Land on the admin, ADDED Requirements, ADDED Requirements
...
Cohesion: 0.40
Nodes (3): ADDED Requirements, Requirement: A bad cold-start migration cannot crash the API, Scenario: One migration errors on cold start

### Community 246 - "Community 246"
Cohesion: 0.40
Nodes (3): Pending (designed + approved, not yet built), Shipped, Tasks

### Community 247 - "Community 247"
Cohesion: 0.40
Nodes (3): ADDED Requirements, Requirement: A job that cannot complete is shown as error, never indefinitely pending, Scenario: A stalled pending job

### Community 248 - "Community 248"
Cohesion: 0.33
Nodes (4): Requirement: Row-action menus are leftmost in every admin table, Scenario: Any table with row actions, ADDED Requirements, ADDED Requirements

### Community 249 - "Community 249"
Cohesion: 0.67
Nodes (3): agb(), { Client }, main()

### Community 250 - "Community 250"
Cohesion: 0.67
Nodes (3): land_area, planted_area, total_area

### Community 251 - "Community 251"
Cohesion: 0.67
Nodes (3): land_ownership, agreement_status, name
...
Cohesion: 0.67
Nodes (3): security_and_infrastructure, description, image_data
